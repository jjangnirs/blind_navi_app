...
| **2. 목적지 검색 & 전국 POI** | 음성/키보드로 전국 장소 입력 ("서울역", "금남로4가역") 후 결과 목록 탐색 | SK TMAP 전국 POI API 실시간 검색, 거리 뱃지(`🚶 350m` / `⚠️ 15km (초과)`), 첫 번째 장소 자동 낭독 | 결과 항목 최소 터치 영역 48dp, 5km 보행 제한 안내, Geocoder 폴백 | **PASS** |
